...
const banners: Banner[] = [
  {
    eyebrow: "Collectie",
    title: "Banken",
    description: "Van hoekbank tot bankstel — strak en comfortabel.",
    href: "/banken",
    cta: "Bekijk banken",
  ...
  {
    eyebrow: "Sfeer",
    title: "Licht & verlichting",
    description: "Plafond-, vloer- en tafellampen voor warm licht.",
    href: "/verlichting",
    cta: "Ontdek verlichting",
