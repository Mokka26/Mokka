...
export default function ProductCard({ product, variants, priority = false }: Props) {
  ...
  // Vierkante kaart (1:1) met c_fill + g_auto: élke kaart vult de tegel exact
  // (geen witruimte), ongeacht de bronverhouding. Vierkante foto's passen
  // precies; liggende/staande foto's worden rond het onderwerp bijgesneden.
  // Eén uniforme regel voor álle categorieën → alle kaarten even groot.
